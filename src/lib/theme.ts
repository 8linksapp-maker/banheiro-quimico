...
import banheiro from '../data/themes/banheiro.json';
...
export const PRESETS: Record<string, ThemePreset> = { dental, harmonizacao, vidro, banheiro };
...
export function resolveTheme(): { vars: Record<string, string>; preset: ThemePreset } {
  const preset = PRESETS[themeConfig.preset] ?? PRESETS.banheiro;
